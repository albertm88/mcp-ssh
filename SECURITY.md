...
| --- | --- |
| `1.0.1` (current release) | Actively supported |
| `1.0.0-main` | Actively supported |
...
Windows and Linux (including WSL2). macOS is **not** a supported platform.

## Report a vulnerability

Do not open a public issue or include credentials, private keys, hostnames, command output or other sensitive data in a report.
