...
**Cross-platform SSH MCP server (simplified edition)** — let AI assistants safely manage remote servers.
...
| **Simplified** | `lite` (this) | Python + Paramiko | 11 | Trimmed | Merged FS ops, no scan |
...
└─────────────────┘                └──────┬──────┘
              ...
              │ ssh_filesystem│    │          │          │ (redacted)│
              │ ssh_upload│      │ whitelist│          └──────────┘
              │ ...      │        │ manual   │
              └────┬─────┘        │ smart    │
                   │              │ off      │
                   │              └────┬─────┘
